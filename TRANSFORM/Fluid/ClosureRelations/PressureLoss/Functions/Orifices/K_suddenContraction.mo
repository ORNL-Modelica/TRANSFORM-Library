...
function K_suddenContraction
  "Orifice | Sudden Contraction | Laminar, Transition, and Turbulent | Uniform Velocity Distribution"
  // Source: Idelčik, I. E. & Ginevskiĭ, A. S. Handbook of hydraulic resistance. (Begell House, 2007).
  // Diagram 4.9 and 4.10 - Sudden Contraction - Laminar, Transition, and Turbulent Region
...
algorithm
  K_lam := K_suddenContraction_LaminarAndTransition(
    crossAreas,
    Re,
    CFs[1]);
  K_turb := K_suddenContraction_Turbulent(crossAreas, CFs[2]);
