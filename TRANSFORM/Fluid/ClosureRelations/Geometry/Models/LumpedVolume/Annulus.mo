...
model Annulus
  ...
  input SI.Area crossArea_inner = 0.0 "Inner cross sectional area" annotation (Dialog(group="Input Variables"));
  input SI.Area crossArea_outer = 0.0 "Outer cross sectional area" annotation (Dialog(group="Input Variables"));
