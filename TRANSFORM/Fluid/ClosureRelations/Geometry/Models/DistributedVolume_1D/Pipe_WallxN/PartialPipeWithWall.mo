within TRANSFORM.Fluid.ClosureRelations.Geometry.Models.DistributedVolume_1D.Pipe_WallxN;
partial model PartialPipeWithWall

  parameter Integer nR(min=1) = 1 "Number of nodes in wall r-direction";
  parameter Integer nR_2(min=1) = nR "Number of nodes in wall r-direction";
  ...
  input SI.Length drs[nR,nZ](min=0) "Wall unit volume lengths of r-dimension"
    annotation (Dialog(group="Inputs: Wall"));
  input SI.Length drs_2[nR_2,nZ](min=0)=drs "Wall unit volume lengths of r-dimension"
    annotation (Dialog(group="Inputs: Wall"));
  input SI.Length dzs[nR,nZ](min=0) "Wall unit volume lengths of z-dimension"
    annotation (Dialog(group="Inputs: Wall"));
  input SI.Length dzs_2[nR_2,nZ](min=0)=dzs "Wall unit volume lengths of z-dimension"
    annotation (Dialog(group="Inputs: Wall"));
