...
model check_Nus_SinglePhase_2Region_FL
  ...
  TRANSFORM.Fluid.ClosureRelations.HeatTransfer.Models.Lumped.Nus_SinglePhase_2Region
    heatTransfer(
...
end check_Nus_SinglePhase_2Region_FL;
