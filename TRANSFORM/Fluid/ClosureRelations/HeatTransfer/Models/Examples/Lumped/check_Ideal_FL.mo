...
model check_Ideal_FL
  ...
  TRANSFORM.Fluid.ClosureRelations.HeatTransfer.Models.Lumped.Ideal heatTransfer(
  ...
  HeatAndMassTransfer.BoundaryConditions.Heat.HeatFlow boundary[nSurfaces](
      each Q_flow=10)
