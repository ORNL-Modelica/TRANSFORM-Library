...
model check_Alphas_TwoPhase_3Region_CHFtransition_F1D
  ...
  TRANSFORM.Fluid.ClosureRelations.HeatTransfer.Models.DistributedPipe_1D_MultiTransferSurface.Alphas_TwoPhase_3Region_CHFtransition
    heatTransfer(
...
end check_Alphas_TwoPhase_3Region_CHFtransition_F1D;
