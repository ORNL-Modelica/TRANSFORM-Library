within TRANSFORM.Fluid.Machines.BaseClasses.PumpCharacteristics.Models.Power.Examples;
model QuadraticCurve_Test
  ...
  TRANSFORM.Fluid.Machines.BaseClasses.PumpCharacteristics.Models.Power.PerformanceCurve
    powerChar(
