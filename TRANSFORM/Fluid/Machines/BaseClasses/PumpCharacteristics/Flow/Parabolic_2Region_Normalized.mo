...
model Parabolic_2Region_Normalized
  "Parabolic | 2 regions | Normalized"
...
protected
  ...
  Real x=head/affinityLaw_head/(HcDesign*diameter_nominal^2*N_nominal^2*Modelica.Constants.pi/60);
  Real y=V_flow/affinityLaw_flow/(V_flow_nominal);
...
end Parabolic_2Region_Normalized;
