within TRANSFORM.Fluid.Machines.BaseClasses.TurbineCharacteristics.Power.Examples;
model QuadraticCurve_Test
  ...
  TRANSFORM.Fluid.Machines.BaseClasses.PumpCharacteristics.Power.PerformanceCurve
    powerChar(
