within TRANSFORM.Fluid.Machines.BaseClasses.TurbineCharacteristics.Efficiency.Examples;
model QuadraticCurve_Test
  ...
  TRANSFORM.Fluid.Machines.BaseClasses.PumpCharacteristics.Efficiency.QuadraticCurve
    efficiencyChar(
