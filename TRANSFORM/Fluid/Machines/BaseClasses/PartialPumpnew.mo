...
partial model PartialPumpnew "Base model for centrifugal pumps"
  ...
  replaceable model FlowChar =
      TRANSFORM.Fluid.ClosureRelations.PumpCharacteristics.Models.Head.PerformanceCurvenew
    constrainedby
    TRANSFORM.Fluid.ClosureRelations.PumpCharacteristics.Models.Head.PartialFlowChar2
  ...
  FlowChar flowChar(
    ...
    final head=head,
    final head_start=(p_b_start-p_a_start)/Modelica.Constants.g_n/d_start,
