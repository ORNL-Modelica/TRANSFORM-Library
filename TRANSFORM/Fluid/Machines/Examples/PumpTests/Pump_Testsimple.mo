...
model Pump_Testsimple
  ...
  TRANSFORM.Fluid.Machines.Pump_SinglePhase
                                pump(
    redeclare package Medium = Modelica.Media.Water.StandardWater,
    N_nominal=1500,
...
equation
  ...
  connect(pump.port_a, Source.ports[1]) annotation (Line(
      ...
      color={0,127,255},
      thickness=0.5));
  connect(constantSpeed.flange, pump.shaft_b) annotation (Line(points={{-60,46},
          {-62,46},{-62,16},{-24,16},{-24,6}}, color={0,0,0}));
