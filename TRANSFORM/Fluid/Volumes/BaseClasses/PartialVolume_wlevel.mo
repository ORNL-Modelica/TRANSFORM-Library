...
partial model PartialVolume_wlevel "Base class for volume models"
  ...
  parameter Medium.AbsolutePressure p_start=Medium.p_default "Pressure" annotation (
  ...
  parameter Medium.Temperature T_start=Medium.T_default "Temperature" annotation (
...
//     Xi(start=X_start[1:Medium.nXi]));
  ...
  SIadd.ExtraPropertyExtrinsic[Medium.nC] mC_scaled "Scaled trace substance for improved numerical stability";
