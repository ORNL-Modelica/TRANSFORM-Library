...
equation
 total_Q_MW=sum(SG_1.riser.heatPort.Q_flow + SG_2.riser.heatPort.Q_flow + SG_3.riser.heatPort.Q_flow+SG_1.riser1.heatPort.Q_flow + SG_2.riser1.heatPort.Q_flow + SG_3.riser1.heatPort.Q_flow)*1e-6;
  connect(const.y, SG_1.Q_fromPHS) annotation (Line(points={{-171,18},{-91,
          18},{-91,17.4545}},
                         color={0,0,127}));
  connect(const1.y, SG_2.Q_fromPHS) annotation (Line(points={{-171,-26},
          {-132,-26},{-132,-28.5455},{-91,-28.5455}},
                                           color={0,0,127}));
  connect(const2.y, SG_3.Q_fromPHS) annotation (Line(points={{-173,-76},
          {-134,-76},{-134,-70.5455},{-91,-70.5455}},
                                           color={0,0,127}));
