within TRANSFORM.Fluid.Pipes_Obsolete.ClosureModels.PumpCharacteristics.Models.Head.Examples;
model QuadraticCurve_Test
  ...
  TRANSFORM.Fluid.Pipes_Obsolete.ClosureModels.PumpCharacteristics.Models.Head.QuadraticCurve
    quadraticCurve(
