within TRANSFORM.Fluid.Pipes_Obsolete.ClosureModels.PumpCharacteristics.Models.Flow.Examples;
model QuadraticCurve_Test
  ...
  parameter SI.Pressure p_a_start = p;
  ...
  TRANSFORM.Fluid.Pipes_Obsolete.ClosureModels.PumpCharacteristics.Models.Flow.QuadraticCurve
    quadraticCurve(
...
equation
  ...
  W_total = quadraticCurve.m_flow/rho*dp.y;
