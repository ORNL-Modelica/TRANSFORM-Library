within TRANSFORM.Fluid.Pipes_Obsolete.ClosureModels.PumpCharacteristics.Models.Power.Examples;
model QuadraticCurve_Test
  ...
  TRANSFORM.Fluid.Pipes_Obsolete.ClosureModels.PumpCharacteristics.Models.Power.QuadraticCurve
    powerChar(
