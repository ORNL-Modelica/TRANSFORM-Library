...
model Entrance
  ...
  TRANSFORM.Fluid.FittingsAndResistances.Entrance from_dp(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    dimension=0.05,
    K=0.5) "sharp-edged entrance, K=0.5"
  ...
  TRANSFORM.Fluid.FittingsAndResistances.Entrance from_mflow(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    dimension=0.05,
    K=0.5) annotation (Placement(transformation(extent={{-10,-50},{10,-30}})));
equation
...
<p>Unit test for <a href=\"modelica://TRANSFORM.Fluid.FittingsAndResistances.Entrance\">Entrance</a> (sharp-edged,
K=0.5). <code>from_dp</code> is pressure-driven and <code>from_mflow</code> uses a sinusoidal flow.</p>
</html>"));
end Entrance;
