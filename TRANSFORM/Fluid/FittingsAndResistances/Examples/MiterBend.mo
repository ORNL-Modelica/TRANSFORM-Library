...
model MiterBend
  ...
  TRANSFORM.Fluid.FittingsAndResistances.MiterBend from_dp(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    dimension=0.05,
    angle=Modelica.Constants.pi/2) "90 deg mitered bend"
  ...
  TRANSFORM.Fluid.FittingsAndResistances.MiterBend from_mflow(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    dimension=0.05,
    angle=Modelica.Constants.pi/2) "90 deg mitered bend"
...
<p>Unit test for <a href=\"modelica://TRANSFORM.Fluid.FittingsAndResistances.MiterBend\">MiterBend</a> (90&deg;).
<code>from_dp</code> is pressure-driven and <code>from_mflow</code> is driven by a sinusoidal (sign-changing) mass flow
rate, verifying the loss magnitude and correct flow-reversal behaviour.</p>
</html>"));
end MiterBend;
