...
model Exit
  ...
  TRANSFORM.Fluid.FittingsAndResistances.Exit from_dp(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    dimension=0.05,
    K=1.0) "exit into plenum, K=1"
  ...
  TRANSFORM.Fluid.FittingsAndResistances.Exit from_mflow(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    dimension=0.05,
    K=1.0) annotation (Placement(transformation(extent={{-10,-50},{10,-30}})));
equation
...
<p>Unit test for <a href=\"modelica://TRANSFORM.Fluid.FittingsAndResistances.Exit\">Exit</a> (K=1). <code>from_dp</code> is
pressure-driven and <code>from_mflow</code> uses a sinusoidal flow.</p>
</html>"));
end Exit;
