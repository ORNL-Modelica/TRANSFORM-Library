...
model Orifice
  ...
  TRANSFORM.Fluid.FittingsAndResistances.Orifice from_dp(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    dimension=0.05,
    diameter_orifice=0.025) "area ratio 0.25 -> K ~ 14"
  ...
  TRANSFORM.Fluid.FittingsAndResistances.Orifice from_mflow(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    dimension=0.05,
    diameter_orifice=0.025)
...
<p>Unit test for <a href=\"modelica://TRANSFORM.Fluid.FittingsAndResistances.Orifice\">Orifice</a> (25 mm bore in a 50 mm
pipe, area ratio 0.25). <code>from_dp</code> is pressure-driven and <code>from_mflow</code> uses a sinusoidal flow,
verifying the loss and flow reversal.</p>
</html>"));
end Orifice;
