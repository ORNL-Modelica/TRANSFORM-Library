...
model PerforatedPlate
  ...
  TRANSFORM.Fluid.FittingsAndResistances.PerforatedPlate from_dp(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    dimension=0.05,
    porosity=0.3) "30% open area"
  ...
  TRANSFORM.Fluid.FittingsAndResistances.PerforatedPlate from_mflow(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    dimension=0.05,
    porosity=0.3)
...
<p>Unit test for <a href=\"modelica://TRANSFORM.Fluid.FittingsAndResistances.PerforatedPlate\">PerforatedPlate</a> (30%
open area). <code>from_dp</code> is pressure-driven and <code>from_mflow</code> uses a sinusoidal flow, verifying the loss
and flow reversal.</p>
</html>"));
end PerforatedPlate;
