...
model TraceSeparator_Test
  ...
  replaceable package Medium = Modelica.Media.IdealGases.SingleGases.He (
        extraPropertiesNames=fill("dummy",4)) constrainedby Modelica.Media.Interfaces.PartialMedium
                                            "Medium properties" annotation (
      choicesAllMatching=true);
  replaceable package Medium_carrier =
      Modelica.Media.IdealGases.SingleGases.He (
       extraPropertiesNames=fill("dummy",4),
  C_nominal=fill(1e6,Medium_carrier.nC)) constrainedby Modelica.Media.Interfaces.PartialMedium
                                            "Medium properties" annotation (
      choicesAllMatching=true);
