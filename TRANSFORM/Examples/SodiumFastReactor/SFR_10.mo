...
equation
  ...
  connect(resistance_toIHX.port_b, IHX.port_a_shell) annotation (Line(points={{-19,
          -6},{19.4,-6},{19.4,-20}}, color={0,127,255}));
  ...
  connect(IHTS.port_a, IHX.port_a_tube) annotation (Line(points={{60,-40},{40,-40},
          {40,-52},{24,-52},{24,-40}}, color={0,127,255}));
  annotation (
