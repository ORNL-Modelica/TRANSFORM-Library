within TRANSFORM.Examples.SodiumFastReactor.BaseClasses;
partial model Partial_SubSystem_A
  ...
  import Modelica.Constants;
   ...
   Fluid.Interfaces.FluidPort_State      port_a(redeclare package
      Medium =
   ...
   Fluid.Interfaces.FluidPort_Flow       port_b(redeclare package
      Medium =
