...
model SFR_9
  ...
  UserInteraction.Outputs.SpatialPlot2 spatialPlot2_1(
    ...
    x2=if IHX[1].counterCurrent == true then Modelica.Math.Vectors.reverse(IHX[
        1].shell.summary.xpos_norm) else IHX[1].shell.summary.xpos_norm,
...
equation
  ...
  connect(resistance_toIHX.port_b, IHX.port_a_shell) annotation (Line(points={{
          -19,-6},{19.4,-6},{19.4,-20}}, color={0,127,255}));
  connect(IHX.port_b_shell, lowerPlenum_outer.port_a[1:3]) annotation (Line(
        points={{19.4,-40},{20,-40},{20,-99.3333},{16,-99.3333}}, color={0,127,
          255}));
  ...
  connect(IHTS.port_b, IHX.port_b_tube)
    annotation (Line(points={{60,-10},{24,-10},{24,-20}}, color={0,127,255}));
  connect(IHTS.port_a, IHX.port_a_tube) annotation (Line(points={{60,-40},{40,
          -40},{40,-52},{24,-52},{24,-40}}, color={0,127,255}));
  annotation (
