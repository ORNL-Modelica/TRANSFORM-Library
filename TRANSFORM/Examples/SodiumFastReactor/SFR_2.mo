...
equation
  ...
  connect(shield.port_a, pump_SimpleMassFlow[1].port_b) annotation (Line(points=
         {{-100,-96},{-100,-138},{-60,-138},{-60,-140}}, color={0,127,255}));
  connect(reflector.port_a, pump_SimpleMassFlow[2].port_b) annotation (Line(
        points={{-80,-96},{-80,-132},{-60,-132},{-60,-140}}, color={0,127,255}));
  connect(outerCore_in.port_a, pump_SimpleMassFlow[3].port_b)
    annotation (Line(points={{-60,-124},{-60,-140}}, color={0,127,255}));
  connect(innerCore_in.port_a, pump_SimpleMassFlow[4].port_b) annotation (Line(
        points={{-38,-124},{-38,-140},{-60,-140}}, color={0,127,255}));
  connect(pump_SimpleMassFlow.port_a, upperPlenum1.port_b[1:4]) annotation (
      Line(points={{-60,-160},{-34,-160},{-34,-160.75},{-8,-160.75}}, color={0,
          127,255}));
  connect(upperPlenum1.port_a[1], STHX.port_b_shell) annotation (Line(points={{
          4,-160},{65.4,-160},{65.4,-84}}, color={0,127,255}));
  connect(expansionTank.port, resistance_toExpTank.port_b)
    annotation (Line(points={{-60,3.6},{-60,-5}}, color={0,127,255}));
  connect(resistance_toExpTank.port_a, upperPlenum.port_b[1]) annotation (Line(
        points={{-60,-19},{-60,-24},{-60,-28},{-59.3333,-28}}, color={0,127,255}));
  connect(resistance_toIHX1.port_a, upperPlenum.port_b[2]) annotation (Line(
        points={{-7,-26},{-60,-26},{-60,-28}}, color={0,127,255}));
  connect(boundary_dummy.ports[1], upperPlenum.port_b[3]) annotation (Line(
        points={{-114,-22},{-60.6667,-22},{-60.6667,-28}}, color={0,127,255}));
  annotation (
