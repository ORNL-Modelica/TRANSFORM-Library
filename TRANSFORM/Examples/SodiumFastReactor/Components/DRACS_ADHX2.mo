...
equation
  ...
  connect(atmosphere1.ports[1], port_a) annotation (Line(points={{-132,-60},{
          -100,-60}},                       color={0,127,255}));
  connect(blower1.ports[1], port_b) annotation (Line(points={{-120,40},{-100,40}},
                                color={0,127,255}));
  connect(pipe.port_b, resistance_toPump.port_b)
    annotation (Line(points={{50,-20},{50,-60},{17,-60}}, color={0,127,255}));
