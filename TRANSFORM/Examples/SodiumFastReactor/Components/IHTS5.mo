...
replaceable package Medium =
  ...
  AirHX airHX[3](redeclare package Medium = Medium)
...
equation
  ...
  connect(resistance_toExpTank1.port_a, volume_fromAHX.port_b[1]) annotation (
  ...
  connect(airHX.port_a, volume_toAHX.port_b[1:3]) annotation (Line(points={{70,0},{
          54,0},{54,40.6667},{42,40.6667}},     color={0,127,255}));
  connect(airHX.port_b, volume_fromAHX.port_a[1:3]) annotation (Line(points={{70,-8},
          {54,-8},{54,-59.3333},{42,-59.3333}},        color={0,127,255}));
