...
model SFR_8
 ...
 SI.HeatFlowRate Q_total_tube = sum(STHX.tube.heatTransfer.Q_flows);
  ...
  HeatExchangers.GenericDistributed_HX STHX_AHX_1(
    ...
    p_a_start_tube=200000) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={260,-18})));
  ...
  Fluid.BoundaryConditions.Boundary_pT boundary5(
    ...
    p=100000,
    T=323.15)
    annotation (Placement(transformation(extent={{350,-58},{330,-38}})));
  ...
  Fluid.BoundaryConditions.Boundary_pT boundary8(
    nPorts=1,
    redeclare package Medium = Medium_Ambient,
    p=100000,
    T=323.15)
    annotation (Placement(transformation(extent={{348,-116},{328,-96}})));
  Modelica.Fluid.Sources.MassFlowSource_T boundary10(
    nPorts=1,
    redeclare package Medium = Medium_Ambient,
    m_flow=100,
    T=298.15)
    annotation (Placement(transformation(extent={{354,-154},{334,-134}})));
equation
  ...
  connect(resistance_toExpTank4.port_b, boundary_dummy3.ports[1]) annotation (
      Line(points={{203,-104},{208,-104},{208,-104},{212,-104}}, color={0,127,
          255}));
  connect(boundary4.ports[1], STHX_AHX_1.port_b_shell) annotation (Line(points=
          {{302,50},{282,50},{282,36},{264.6,36},{264.6,-8}}, color={0,127,255}));
  connect(STHX_AHX_1.port_a_shell, boundary7.ports[1]) annotation (Line(points=
          {{264.6,-28},{280,-28},{280,6},{296,6},{296,14},{310,14}}, color={0,
          127,255}));
  connect(boundary5.ports[1], STHX_AHX_2.port_b_shell) annotation (Line(points=
          {{330,-48},{286,-48},{286,-44},{264.6,-44},{264.6,-50}}, color={0,127,
          255}));
  connect(STHX_AHX_2.port_a_shell, boundary6.ports[1]) annotation (Line(points=
          {{264.6,-70},{270,-70},{270,-82},{332,-82}}, color={0,127,255}));
  connect(boundary8.ports[1], STHX_AHX_3.port_b_shell) annotation (Line(points=
          {{328,-106},{302,-106},{302,-90},{276,-90},{266,-90},{266,-92},{266.6,
          -92}}, color={0,127,255}));
  connect(STHX_AHX_3.port_a_shell, boundary10.ports[1]) annotation (Line(points=
         {{266.6,-112},{274,-112},{274,-118},{280,-118},{280,-144},{334,-144}},
        color={0,127,255}));
  connect(pipe_IHTSfromIHX[1].port_b, STHX_AHX_1.port_a_tube) annotation (Line(
        points={{60,-10},{138,-10},{138,0},{260,0},{260,-8}}, color={0,127,255}));
  connect(pipe_IHTSfromIHX[2].port_b, STHX_AHX_2.port_a_tube) annotation (Line(
        points={{60,-10},{142,-10},{142,-6},{248,-6},{248,-44},{260,-44},{260,
          -50}}, color={0,127,255}));
  connect(pipe_IHTSfromIHX[3].port_b, STHX_AHX_3.port_a_tube) annotation (Line(
        points={{60,-10},{154,-10},{154,-4},{248,-4},{248,-84},{262,-84},{262,
          -92}}, color={0,127,255}));
  connect(pipe_IHTStoPump_3.port_a, STHX_AHX_3.port_b_tube) annotation (Line(
        points={{208,-120},{262,-120},{262,-112}}, color={0,127,255}));
  connect(pipe_IHTStoPump_2.port_a, STHX_AHX_2.port_b_tube) annotation (Line(
        points={{206,-80},{260,-80},{260,-70}}, color={0,127,255}));
  connect(pipe_IHTStoPump_1.port_a, STHX_AHX_1.port_b_tube) annotation (Line(
        points={{206,-40},{260,-40},{260,-28}}, color={0,127,255}));
  annotation (
