...
equation
  ...
  connect(_4.port_a, _3.port_b) annotation (Line(points={{-104.929,110.929},{-104.929,
          105.465},{-100,105.465},{-100,100}}, color={0,127,255}));
  connect(_4.port_b, _5.port_a) annotation (Line(points={{-119.071,125.071},{-126,
          125.071},{-126,140},{-120,140}}, color={0,127,255}));
  connect(_5.port_b, _6.port_a) annotation (Line(points={{-100,140},{42.9289,140},
          {42.9289,148.929}}, color={0,127,255}));
  connect(_6.port_b, _6a.port_a) annotation (Line(points={{57.0711,163.071},{62.9289,
          168.929}}, color={0,127,255}));
  ...
  connect(_8.port_b, _9.port_a) annotation (Line(points={{62,80},{62,73.0711},
          {66.9289,73.0711}},
                     color={0,127,255}));
  connect(_9.port_b, _10.port_a) annotation (Line(points={{81.0711,58.9289},{81.0711,
          51.4644},{90,51.4644},{90,40}}, color={0,127,255}));
  ...
  connect(_17.port_b, _18.port_a) annotation (Line(points={{-60,-20},{-60,-30.9289},
          {-68.9289,-30.9289}}, color={0,127,255}));
  connect(_16.port_b, _17.port_a)
    annotation (Line(points={{-60,8},{-60,0}}, color={0,127,255}));
  connect(_16.port_a, _15.port_b) annotation (Line(points={{-60,28},{-60,40.9289},
          {-53.0711,40.9289}}, color={0,127,255}));
