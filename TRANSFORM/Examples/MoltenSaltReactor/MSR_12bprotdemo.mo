...
model MSR_12bprotdemo
  ...
  parameter Integer iOG[:] = {1,4}+fill(data_traceSubstances.precursorGroups.nC, 2) "Index array of substances sent to off-gas system";
...
public
  TRANSFORM.Nuclear.ReactorKinetics.PointKinetics_Drift kinetics(
    ...
    w_FP_decay=data_traceSubstances.fissionProducts.w_near_decay,
    ...
    SigmaF=26,
    wG_FP_decay=data_traceSubstances.fissionProducts.w_far_decay,
