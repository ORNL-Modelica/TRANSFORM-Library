...
parameter SI.Pressure p_outlet_shell = p_inlet_shell - dp_shell
    "Outlet pressure";
parameter SI.MassFlowRate m_flow_tube = from_lbm_hr(1.79e6)
...
parameter SI.Length length_tube = from_inch(37.5*12)
    "Tubesheet to tubesheet distance";
parameter SI.Area surfaceArea_tubeouter = D_tube_outer*pi*length_tube*nTubes
    "Surface area outer tube basis";                                                                         //TRANSFORM.Units.Conversions.Functions.Area_m2.from_feet2(5904);
...
parameter SI.Length D_diskBaffle = from_inch(22)
    "Outer diameter of disk type baffle";
parameter SI.Length D_doughnutBaffle = from_inch(21.6)
