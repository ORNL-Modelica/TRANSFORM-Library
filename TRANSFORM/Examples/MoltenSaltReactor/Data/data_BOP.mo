...
model data_BOP
  ...
  parameter SI.Pressure p_outlet_HP = from_psi(1146) "Outlet pressure from HP turbine";
  parameter SI.Pressure p_outlet_LP = from_psi(500) "Outlet pressure from HP turbine";
