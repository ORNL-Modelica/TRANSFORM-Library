...
model MSR_10
  ...
  SI.MassFlowRate[data_traceSubstances.nC] mC_gen_drainTank_gas_PtoD =  {(if (j>=data_traceSubstances.iFP[1] and j<= data_traceSubstances.iFP[2]) then sum(data_traceSubstances.fissionProducts.lambdas.*drainTank_gas.mC[data_traceSubstances.iFP[1]:data_traceSubstances.iFP[2]].*data_traceSubstances.fissionProducts.parents[j-data_traceSubstances.iFP[1]+1,:]) else 0) for j in 1:data_traceSubstances.nC};
