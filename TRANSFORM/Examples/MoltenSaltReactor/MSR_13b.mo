...
parameter SI.MoleFraction Li6_molefrac = 1.0-Li7_molefrac "Mole fraction of lithium in flibe that is Li-6";
  ...
  SI.Power Qs_total[kinetics.nV] = kinetics.Qs;
  SI.Power Qs_decay[kinetics.nV] = kinetics.Qs_decay_total;
  SI.Temperature T_max = max(Ts);
protected
...
protected
  ...
  TRANSFORM.Nuclear.ReactorKinetics.Kinetics_L1_atomBased_external kinetics(
    nV=fuelCell.nV,
    ...
    rhos_input=fill(add.y, kinetics.nV),
    dLambda=add1.y)
...
public
  Modelica.Blocks.Sources.Constant const(k=0)
    annotation (Placement(transformation(extent={{-252,-200},{-232,-180}})));
  Modelica.Blocks.Sources.RealExpression realExpression(y=Qt_total)
    annotation (Placement(transformation(extent={{-174,-174},{-154,-154}})));
  Modelica.Blocks.Math.Add add
    annotation (Placement(transformation(extent={{-226,-170},{-206,-150}})));
  Modelica.Blocks.Interfaces.RealInput u annotation (Placement(transformation(
          extent={{-306,-162},{-266,-122}}), iconTransformation(extent={{-392,
            -88},{-352,-48}})));
  Modelica.Blocks.Interfaces.RealOutput y annotation (Placement(transformation(
          extent={{-114,-160},{-94,-140}}), iconTransformation(extent={{-374,
            -60},{-354,-40}})));
public
  Modelica.Blocks.Sources.Constant const1(k=0)
    annotation (Placement(transformation(extent={{-142,-284},{-122,-264}})));
  Modelica.Blocks.Math.Add add1
    annotation (Placement(transformation(extent={{-116,-254},{-96,-234}})));
  Modelica.Blocks.Interfaces.RealInput u1
                                         annotation (Placement(transformation(
          extent={{-196,-246},{-156,-206}}), iconTransformation(extent={{-392,
            -88},{-352,-48}})));
  Modelica.Blocks.Sources.RealExpression realExpression1(y=T_max)
    annotation (Placement(transformation(extent={{-88,-206},{-68,-186}})));
  Modelica.Blocks.Interfaces.RealOutput y1
                                          annotation (Placement(transformation(
          extent={{-28,-192},{-8,-172}}),   iconTransformation(extent={{-374,
            -60},{-354,-40}})));
equation
  ...
  connect(boundary_OffGas_T1.y, pump_drainTank.in_m_flow) annotation (Line(
        points={{-201,-42},{-196,-42},{-196,-52.7},{-190,-52.7}}, color={0,0,
          127}));
  connect(realExpression.y, y) annotation (Line(points={{-153,-164},{-131.5,
          -164},{-131.5,-150},{-104,-150}}, color={0,0,127}));
  connect(u, add.u1) annotation (Line(points={{-286,-142},{-257,-142},{-257,
          -154},{-228,-154}}, color={0,0,127}));
  connect(const.y, add.u2) annotation (Line(points={{-231,-190},{-228,-190},{
          -228,-166},{-228,-166}}, color={0,0,127}));
  connect(u1, add1.u1) annotation (Line(points={{-176,-226},{-147,-226},{-147,-238},
          {-118,-238}}, color={0,0,127}));
  connect(const1.y, add1.u2) annotation (Line(points={{-121,-274},{-118,-274},{-118,
          -250},{-118,-250}}, color={0,0,127}));
  connect(realExpression1.y, y1) annotation (Line(points={{-67,-196},{-45.5,-196},
          {-45.5,-182},{-18,-182}}, color={0,0,127}));
