...
model CondensationSmooth_Example
  "Example of a condensation HX with smoothing"
  import TRANSFORM;
  ...
  TRANSFORM.HeatExchangers.CondensationHXSmooth CondensationHx(
    ...
    V_condensation1=0.000001,
    R_condensation2=(p_2[2] - p_2[3])/m_flow_2,
    V_condensation2=0.000001,
  ...
  UserInteraction.Outputs.NumericValue numericValue2(precision=3, input_Value
      =CondensationHx.Q_flow_condensation/1e6)
...
equation
  ...
  connect(ramp.y, tube_inlet.h_in) annotation (Line(points={{81,-50},{86,-50},
          {86,-13.6},{80.2,-13.6}}, color={0,0,127}));
  annotation (
...
end CondensationSmooth_Example;
