...
model CondensationConvectionHX "Condensing and convecting HX"
...
equation
  ...
  Q_flow_condensation =condensationHX.Q_flow_condensation;
  ...
  connect(port_b1, convectionHX.port_b1) annotation (Line(points={{100,40},{70,
          40},{70,4},{60,4}}, color={0,127,255}));
  connect(condensationHX.port_a1, port_a1) annotation (Line(points={{-60,4},{-86,
          4},{-86,40},{-100,40}}, color={0,127,255}));
  connect(condensationHX.port_b1, convectionHX.port_a1)
    annotation (Line(points={{-40,4},{40,4}}, color={0,127,255}));
  connect(condensationHX.port_a2, convectionHX.port_b2)
    annotation (Line(points={{-40,-4},{40,-4}}, color={0,127,255}));
  connect(condensationHX.port_b2, port_b2) annotation (Line(points={{-60,-4},{
          -86,-4},{-86,-40},{-100,-40}}, color={0,127,255}));
