...
model LimPID_HysteresisTimer
  ...
  LimPID PID(
    ...
    yb=yb,
    k_s=k_s,
    k_m=k_m)             "Controller to track setpoint"
    annotation (Placement(transformation(extent={{-10,-60},{10,-40}})));
  TRANSFORM.Blocks.OffTimer offHys
...
equation
  ...
  connect(u_m, switch1.u3) annotation (Line(
      points={{-1.11022e-15,-120},{-1.11022e-15,-90},{-80,-90},{-80,-58},{-42,
          -58}},
      color={0,0,127}));
  connect(switch1.y,PID. u_s) annotation (Line(
      points={{-19,-50},{-12,-50}},
      color={0,0,127}));
...
<a href=\"modelica://TRANSFORM.Controls.LimPID_Hysteresis\">
TRANSFORM.Controls.LimPID_Hysteresis</a> but in addition,
