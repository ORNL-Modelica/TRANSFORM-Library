...
equation
  ...
  y_easeIn = TRANSFORM.Math.Scratch.Easing.Sine.easeIn(
    pos=pos,
    neg=neg,
    x=time - x0,
    deltax=deltax);
  ...
  y_easeOut = TRANSFORM.Math.Scratch.Easing.Sine.easeOut(
    pos=pos,
    neg=neg,
    x=time - x0,
    deltax=deltax);
  ...
  y_easeInOut = TRANSFORM.Math.Scratch.Easing.Sine.easeInOut(
    pos=pos,
    neg=neg,
    x=time - x0,
    deltax=deltax);
