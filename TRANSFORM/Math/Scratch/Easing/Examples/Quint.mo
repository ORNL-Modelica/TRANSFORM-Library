...
equation
  ...
  y_easeIn = TRANSFORM.Math.Scratch.Easing.Quint.easeIn(
    pos=pos,
    neg=neg,
    x=time - x0,
    deltax=deltax);
  ...
  y_easeOut = TRANSFORM.Math.Scratch.Easing.Quint.easeOut(
    pos=pos,
    neg=neg,
    x=time - x0,
    deltax=deltax);
  ...
  y_easeInOut = TRANSFORM.Math.Scratch.Easing.Quint.easeInOut(
    pos=pos,
    neg=neg,
    x=time - x0,
    deltax=deltax);
