...
equation
  ...
  y_easeIn = TRANSFORM.Math.Scratch.Easing.Expo.easeIn(
    pos=pos,
    neg=neg,
    x=time - x0,
    deltax=deltax);
  ...
  y_easeOut = TRANSFORM.Math.Scratch.Easing.Expo.easeOut(
    pos=pos,
    neg=neg,
    x=time - x0,
    deltax=deltax);
  ...
  y_easeInOut = TRANSFORM.Math.Scratch.Easing.Expo.easeInOut(
    pos=pos,
    neg=neg,
    x=time - x0,
    deltax=deltax);
