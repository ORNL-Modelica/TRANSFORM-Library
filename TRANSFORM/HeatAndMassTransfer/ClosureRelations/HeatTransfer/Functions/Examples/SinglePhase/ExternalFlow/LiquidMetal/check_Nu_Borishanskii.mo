...
equation
  ...
  y[1] =
    TRANSFORM.HeatAndMassTransfer.ClosureRelations.HeatTransfer.Functions.SinglePhase.ExternalFlow.LiquidMetal.Nu_Borishanskii(
    Re.y,
    Pr,
    PDratio);

  annotation (experiment(StopTime=2, __Dymola_NumberOfIntervals=80));
end check_Nu_Borishanskii;
