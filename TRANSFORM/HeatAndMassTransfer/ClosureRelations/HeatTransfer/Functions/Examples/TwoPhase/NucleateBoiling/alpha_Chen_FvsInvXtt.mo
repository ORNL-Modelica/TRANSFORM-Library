within TRANSFORM.HeatAndMassTransfer.ClosureRelations.HeatTransfer.Functions.Examples.TwoPhase.NucleateBoiling;
...
public
  Utilities.ErrorAnalysis.UnitTests           unitTests(n=3, x={alpha,F,
        X_tt_inv})
