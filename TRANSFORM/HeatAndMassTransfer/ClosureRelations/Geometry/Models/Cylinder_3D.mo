...
model Cylinder_3D
  ...
  input SI.Length drs[nR,nTheta,nZ](min=0) = fill((r_outer-r_inner)/nR,nR,nTheta,nZ) "Unit volume lengths of r-dimension" annotation(Dialog(group="Input Variables"));
  input SI.Angle dthetas[nR,nTheta,nZ](min=0) = fill(angle_theta/nTheta,nR,nTheta,nZ)  "Unit volume lengths of theta-dimension" annotation(Dialog(group="Input Variables"));
  input SI.Length dzs[nR,nTheta,nZ](min=0) = fill((length_z)/nZ,nR,nTheta,nZ) "Unit volume lengths of z-dimension" annotation(Dialog(group="Input Variables"));
