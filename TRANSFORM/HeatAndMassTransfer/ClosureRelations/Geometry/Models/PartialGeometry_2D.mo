...
partial model PartialGeometry_2D
  ...
  parameter Boolean closedDim_1[ns[2]](fixed=false) "=true if the conduction path is closed on itself for specified dimension";
  parameter Boolean closedDim_2[ns[1]](fixed=false) "=true if the conduction path is closed on itself for specified dimension";
