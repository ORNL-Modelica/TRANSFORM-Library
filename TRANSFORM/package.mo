...
<p><span style=\"font-family: MS Shell Dlg 2;\">Package <b>TRANSFORM</b> is a <b>standardized</b> and <b>free</b> package that is developed with the Modelica&reg; language from the Modelica Association, see <a href=\"https://www.Modelica.org\">https://www.Modelica.org</a>. It provides model components in many domains that are based on standardized interface definitions.</span></p>
<ul>
