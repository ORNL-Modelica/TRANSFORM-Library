...
model data_traceSubstances
  ...
  replaceable record PrecursorGroups =
      TRANSFORM.Nuclear.Data.PrecursorGroups.precursorGroups_6_description
    constrainedby TRANSFORM.Nuclear.Data.PrecursorGroups.PartialPrecursorGroup
  ...
  replaceable record FissionProducts =
      TRANSFORM.Nuclear.Data.FissionProducts.fissionProducts_test
    constrainedby TRANSFORM.Nuclear.Data.FissionProducts.PartialFissionProduct
    "Fission product information" annotation (choicesAllMatching=true);

  FissionProducts fissionProducts;

  replaceable record Tritium =
      TRANSFORM.Nuclear.Data.Tritium.FLiBe constrainedby
    TRANSFORM.Nuclear.Data.Tritium.PartialTritium
