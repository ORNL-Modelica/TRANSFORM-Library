...
model summary_traceSubstances
  ...
  constant Real[data_FP.nC,nC] p_FP=cat(
      ...
      fill(
        ...
        nC - data_FP.nC),
      data_FP.parents);
  constant Real[data_TR.nC,nC] p_Tr=cat(
      2,
      fill(
        0,data_TR.nC,
        nC -data_TR.nC),data_TR.parents);
