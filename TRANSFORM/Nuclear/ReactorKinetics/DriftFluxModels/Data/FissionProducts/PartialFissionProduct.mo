within TRANSFORM.Nuclear.ReactorKinetics.DriftFluxModels.Data.FissionProducts;
partial record PartialFissionProduct
  ...
  parameter Integer l_lambdas_col[:] annotation(Evaluate=true, HideArray=true);
  parameter Integer l_lambdas_count[nC] annotation(Evaluate=true, HideArray=true);
  ...
  parameter Integer f_sigmasA_col[:] annotation(Evaluate=true, HideArray=true);
  parameter Integer f_sigmasA_count[nC] annotation(Evaluate=true, HideArray=true);
