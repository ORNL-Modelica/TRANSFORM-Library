...
model FissionProduct_Test_sparseMatrix
  ...
  SIadd.ExtraPropertyExtrinsic mCs[1,fissionProducts.nC](start=mCs_start);

  parameter Real mCs_old_start[1,3]={{0,0,0}};
  SIadd.ExtraPropertyExtrinsic mCs_old[1,fissionProducts_old.nC](start=
        mCs_old_start);
...
equation
  ...
  der(mCs) = fissionProducts.mC_gens;
  der(mCs_old) =fissionProducts_old.mC_gens;
...
end FissionProduct_Test_sparseMatrix;
