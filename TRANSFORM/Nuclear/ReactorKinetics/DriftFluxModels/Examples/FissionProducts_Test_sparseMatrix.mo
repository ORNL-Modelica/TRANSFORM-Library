...
model FissionProducts_Test_sparseMatrix
  ...
  TRANSFORM.Nuclear.ReactorKinetics.DriftFluxModels.Reactivity.FissionProducts_withDecayHeat_sparseMatrix
    fissionProducts_sparseMatrix(
    Q_fission=Q_fission.y,
    mCs_start=mCs_start,         traceDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
      redeclare record Data =
        TRANSFORM.Nuclear.ReactorKinetics.DriftFluxModels.Data.FissionProducts.fissionProducts_TeIXeU,
    use_noGen=true,
    i_noGen=i_noGen)
