...
model FissionProducts_externalBalance_withTritium_withDecayHeat_new

  extends FissionProducts_externalBalance_withTritium_new;
...
equation
  ...
  Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
            {100,100}})));
end FissionProducts_externalBalance_withTritium_withDecayHeat_new;
