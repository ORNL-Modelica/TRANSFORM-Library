...
equation
  ...
  Qs_near_i ={{w_decay[j]*lambda[j]*mCs[i, j] for j in 1:nC} for i in 1:nV};
  Qs_far_i ={{wG_decay[j]*lambda[j]*mCs[i, j] for j in 1:nC} for i in 1:nV};
