...
model FissionProducts_externalBalance_withTritium_withDecayHeat_point

  extends FissionProducts_externalBalance_withTritium_point;
...
equation
  ...
  Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
            {100,100}})));
end FissionProducts_externalBalance_withTritium_withDecayHeat_point;
